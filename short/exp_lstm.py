...
with open(f'results/lstm-short-time-targets.pkl', 'wb') as f:
    pickle.dump(targets, f)

df_results = pd.DataFrame(scores_error)
df_results["model"] = "LSTM"
df_results.to_parquet(f"results/LSTM-short-time.parquet", index=False)
